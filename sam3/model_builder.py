...
def build_sam3_image_model(
    ...
    eval_mode=True,
    checkpoint_path="/bd_byt4090i0/users/omnimotion/dayu/d4sm3/checkpoints/sam3.1_multiplex.pt",
    load_from_HF=False,
...
def build_sam3_video_model(
    ...
    checkpoint_path: Optional[str] = "/bd_byt4090i0/users/omnimotion/dayu/d4sm3/checkpoints/sam3.1_multiplex.pt",
    load_from_HF=False,
    #load_from_HF=True,
